...
use AliOSS\Model\ObjectListInfoV2;
...
use AliOSS\Result\ListObjectsV2Result;
...
use AliOSS\Result\GetBucketInfoResult;
use AliOSS\Model\BucketStat;
use AliOSS\Result\GetBucketStatResult;
use AliOSS\Model\ServerSideEncryptionConfig;
use AliOSS\Result\GetBucketEncryptionResult;
use AliOSS\Model\RequestPaymentConfig;
use AliOSS\Result\GetBucketRequestPaymentResult;
use AliOSS\Model\Tag;
use AliOSS\Model\TaggingConfig;
use AliOSS\Result\GetBucketTagsResult;
use AliOSS\Model\VersioningConfig;
use AliOSS\Result\GetBucketVersioningResult;
use AliOSS\Model\InitiateWormConfig;
use AliOSS\Result\InitiateBucketWormResult;
use AliOSS\Model\ExtendWormConfig;
use AliOSS\Result\GetBucketWormResult;
use AliOSS\Model\RestoreConfig;
use AliOSS\Model\ObjectVersionListInfo;
use AliOSS\Result\ListObjectVersionsResult;
use AliOSS\Model\DeleteObjectInfo;
use AliOSS\Model\DeletedObjectInfo;
use AliOSS\Result\DeleteObjectVersionsResult;
use AliOSS\Model\TransferAccelerationConfig;
use AliOSS\Result\GetBucketTransferAccelerationResult;
use AliOSS\Model\CnameTokenInfo;
use AliOSS\Result\CreateBucketCnameTokenResult;
use AliOSS\Result\GetBucketCnameTokenResult;
...
class OssClient
{
     ...
     *
     * @param string $bucket bucket name    服务器bucket
     * @param string $object object name    服务器目标地址不含bucket
     * @param string $file local file path  本地文件路径
     * @param array $options
     * @return null
     * @throws OssException
     */
     ...
     * @param string $bucket bucket name    服务器bucket
     * @param string $object object name    服务器目标地址不含bucket
     * @param resource $handle file handle  本地文件数据流
     * @param array $options
     * @return null
     * @throws OssException
     */
